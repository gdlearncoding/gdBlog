...
$(document).ready(function(e){
    $('.copyright').html('爱让一切发生 <i class="fa-fw fas fa-heartbeat card-announcement-animation cc_pointer"></i> 爱让一切复活');
})
...
$('.framework-info').html('<span id="span_dt_dt" style="color: #fff;"></span>');
window.setTimeout("show_date_time()", 1000);
BirthDay=new Date("25/12/2024 21:00:00");
today=new Date();
